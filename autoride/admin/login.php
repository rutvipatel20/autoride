					   ...
					   <form method="post">
						  <div class="form-group">
						   <div class="position-relative has-icon-left">
							   <label for="exampleInputUsername" class="sr-only">Email</label>
								 <input type="email" id="exampleInputUsername" name="email" class="form-control" placeholder="Enter Email" required>
						  ...
						  <div class="form-group">
						   <div class="position-relative has-icon-left">
							  ...
							  <input type="password" id="exampleInputPassword" name="password" class="form-control" placeholder="Emter Password" required>
							  <div class="form-control-position">
								  <i class="icon-lock"></i>
							  </div>
						   </div>
              ...
              <?php
						...
						<!-- <div class="form-row mt-4">
						 ...
						 <div class="form-group mb-0 col-6 text-right">
						  <button type="submit" name="login" class="btn bg-twitter text-white btn-block"><i class="fa fa-twitter-square"></i> Twitter</button>
						 </div>
						</div> -->
