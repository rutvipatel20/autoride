    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" class="bg-theme bg-theme2" data-simplebar="" data-simplebar-auto-hide="true">
            ...
            <ul class="sidebar-menu do-nicescrol">
                ...
                <li>
                    <a href="javaScript:void();" class="waves-effect">
                        <i class="zmdi zmdi-view-dashboard"></i> <span>Car Details</span><i
                            class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="sidebar-submenu">
                        <li><a href="index-2.html"><i class="zmdi zmdi-long-arrow-right"></i> New Car</a></li>
                        <li><a href="index2.html"><i class="zmdi zmdi-long-arrow-right"></i> Car View</a></li>
                    </ul>
                </li>

                <li>
                    <a href="index-2.html" class="waves-effect">
                        <i class="zmdi zmdi-calendar-check"></i> <span>Gallery</span>
                    </a>
                </li>

                <li>
                    <a href="javaScript:void();" class="waves-effect">
                        <i class="zmdi zmdi-view-dashboard"></i> <span>User Details</span><i
                            class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="sidebar-submenu">
                        <li><a href="new_user.php"><i class="zmdi zmdi-long-arrow-right"></i> New User</a></li>
                        <li><a href="index2.html"><i class="zmdi zmdi-long-arrow-right"></i> User View</a></li>
                    </ul>
                </li>

                <li>
                    <a href="javaScript:void();" class="waves-effect">
                        <i class="zmdi zmdi-view-dashboard"></i> <span>Driver Details</span><i
                            class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="sidebar-submenu">
                        <li><a href="index-2.html"><i class="zmdi zmdi-long-arrow-right"></i> New Driver</a></li>
                        <li><a href="index2.html"><i class="zmdi zmdi-long-arrow-right"></i> Driver View</a></li>
                    </ul>
                </li>

                <li>
                    <a href="index-2.html" class="waves-effect">
                        <i class="zmdi zmdi-calendar-check"></i> <span>Booking History</span>
                    </a>
                </li>

                <li>
                    <a href="index-2.html" class="waves-effect">
                        <i class="zmdi zmdi-calendar-check"></i> <span>Payment History</span>
                    </a>
                </li>
