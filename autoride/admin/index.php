                    ...
                    <div class="col-12 col-lg-6 col-xl-3">
                        <div class="card gradient-deepblue">
                            <div class="card-body">
                                ...
                                ?>
                                <h5 class="text-white mb-0"><?php print_r($users)?> <span class="float-right"><i
                                            class="fa fa-user"></i></span>
                                </h5>
                                <div class="progress my-3" style="height:3px;">
                                    <div class="progress-bar" style="width:55%"></div>
                                </div>
                                <p class="mb-0 text-white small-font">Total Users <span class="float-right"></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 col-xl-3">
                        <div class="card gradient-orange">
                            <div class="card-body">
                                <?php 
                                    $drivers = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM `driver_user`"));
                                ?>
                                <h5 class="text-white mb-0"><?php print_r($drivers)?> <span class="float-right"><i
                                            class="fa fa-usd"></i></span></h5>
                                <div class="progress my-3" style="height:3px;">
                                    <div class="progress-bar" style="width:55%"></div>
                                </div>
                                <p class="mb-0 text-white small-font">Total Driver <span class="float-right"></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 col-xl-3">
                        <div class="card gradient-ohhappiness">
                            <div class="card-body">
                                <?php 
                                $tdate = date('Y-m-d');
                                    $vehicles = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM `book` where `date` ='$tdate' "));
                                ?>
                                ...
                                <p class="mb-0 text-white small-font">Today Booking <span class="float-right"></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 col-xl-3">
                        <div class="card gradient-ibiza">
                            <div class="card-body">
                                ...
                                ?>
                                <h5 class="text-white mb-0"><?php print_r($books)?> <span class="float-right"><i
                                            class="fa fa-envira"></i></span></h5>
                                <div class="progress my-3" style="height:3px;">
                                    <div class="progress-bar" style="width:55%"></div>
                                </div>
                                <p class="mb-0 text-white small-font">Total Booking <span class="float-right"></p>
                            </div>
                        </div>
                    </div>
                </div>
