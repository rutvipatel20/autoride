        ...
        <div class="row pt-2 pb-2">
            <div class="col-sm-9">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">New Gallary</li>
                </ol>
            </div>
            <div class="col-sm-3">
...
if (isset($_POST['submit'])) {
    ...
    $gallary = "INSERT INTO `gallary`(`image`, `position`, `is_active`) 
        VALUES ('" . $img . "','" . $postion . "','" . $status . "')";

    $gallary_query = mysqli_query($conn, $gallary);
    if ($gallary_query) {
        ?>
        <script>
